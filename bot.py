...
async def admin_panel(m):
    ...
    await m.answer("<b>Админ-панель SpecTech</b>\n\nУправление проверками, оплатами, активными работами и техникой.",reply_markup=admin_web_menu("ru"))
